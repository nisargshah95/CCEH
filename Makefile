CXX := g++
CFLAGS := -std=c++17 -g -I./ -I/mnt/hd/nvm-malloc/src/ -I/root/nisargs/mod-single-repo/nvm_malloc/src/ -lrt -lpthread -O3
...
CCEH_MSB: src/CCEH.h src/CCEH_MSB.cpp
	$(CXX) $(CFLAGS) -c -o src/CCEH_MSB.o src/CCEH_MSB.cpp -DINPLACE -DPMEM
